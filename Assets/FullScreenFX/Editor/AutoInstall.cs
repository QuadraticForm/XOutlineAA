namespace FullScreenFX.AutoInstall 
{
    ...
    {
        const string INSTALL_MARK = "FullScreenFX/Editor/Shield_v2.0.0_installed";
        const string URP = "Assets/FullScreenFX/Packages/Shield_URP.unitypackage";
        const string HDRP = "Assets/FullScreenFX/Packages/Shield_HDRP.unitypackage";
