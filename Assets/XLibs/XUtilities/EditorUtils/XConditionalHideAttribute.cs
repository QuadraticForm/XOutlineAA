...
public class XConditionalHideAttribute : PropertyAttribute
{
    ...
    public CompareMethod Comparison { get; private set; }
    public bool HideInInspector { get; private set; }
    public bool Disable { get; private set; }

    public XConditionalHideAttribute(string conditionFieldName, object compareValue, CompareMethod compareMethod, bool hideInInspector = true, bool disable = false)
    {
        ConditionFieldName = conditionFieldName;
        CompareValue = compareValue;
        Comparison = compareMethod;
